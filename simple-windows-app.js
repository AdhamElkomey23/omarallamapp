...
console.log('Creating Simple Windows Application...');

// Create app directory
if (fs.existsSync('fertilizer-simple-app')) {
  execSync('rm -rf fertilizer-simple-app');
}
fs.mkdirSync('fertilizer-simple-app', { recursive: true });

// Create the HTML application (same content as before but optimized)
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header p { font-size: 1.1rem; color: #4a5568; font-weight: 300; }
        ...
        .nav-tab.active { background: linear-gradient(135deg, #4299e1, #3182ce); color: white; }
        ...
        .stat-card h3 { font-size: 0.9rem; opacity: 0.9; margin-bottom: 10px; font-weight: 400; }
        .stat-card p { font-size: 2.2rem; font-weight: 700; }
        
        .form-container { background: #f7fafc; padding: 25px; border-radius: 15px; margin-bottom: 25px; }
        ...
        .form-field label { font-weight: 600; color: #2d3748; font-size: 0.9rem; }
        ...
        .btn:hover { transform: translateY(-1px); box-shadow: 0 4px 15px rgba(66, 153, 225, 0.4); }
...
<body>
        ...
        <main class="content-panel">
            ...
            <div id="storage" class="panel">
                ...
                <table class="data-table">
                    <thead>
                        <tr><th>المادة</th><th>الكمية المتاحة</th><th>سعر الوحدة</th><th>المورد</th><th>القيمة الإجمالية</th></tr>
                    </thead>
            ...
            <div id="sales" class="panel">
                ...
                <div class="form-container">
                    <div class="form-grid">
                        <div class="form-field">
                            <label>المنتج</label>
                            <select id="sales-product"><option value="">اختر المنتج</option></select>
                        </div>
                        <div class="form-field">
                            <label>الكمية (طن)</label>
                ...
                <table class="data-table">
                    <thead>
                        <tr><th>المنتج</th><th>الكمية</th><th>المبلغ</th><th>العميل</th><th>رقم الهاتف</th><th>التاريخ</th></tr>
                    </thead>
            ...
            <div id="expenses" class="panel">
                ...
                <table class="data-table">
                    <thead>
                        <tr><th>اسم المصروف</th><th>المبلغ</th><th>النوع</th><th>التاريخ</th></tr>
                    </thead>
            ...
            <div id="workers" class="panel">
                ...
                <table class="data-table">
                    <thead>
                        <tr><th>الاسم</th><th>المنصب</th><th>القسم</th><th>الراتب</th><th>تاريخ التوظيف</th></tr>
                    </thead>
    ...
    <script>
        ...
        function saveData() { localStorage.setItem('fertilizerFactoryData', JSON.stringify(appData)); }
        ...
        function getCategoryName(category) {
            const categories = {
                'materials': 'مواد خام', 'utilities': 'كهرباء ومياه', 'salaries': 'رواتب',
                'maintenance': 'صيانة', 'transport': 'نقل ومواصلات', 'other': 'أخرى'
            };
...
fs.writeFileSync('fertilizer-simple-app/FertilizerApp.html', appHTML);

// Create a VERY simple batch file
const simpleBatch = `@echo off
start "" "FertilizerApp.html"`;

fs.writeFileSync('fertilizer-simple-app/RUN.bat', simpleBatch);

// Create an alternative VBS script that runs silently
const vbsScript = `Set objShell = CreateObject("WScript.Shell")
objShell.Run "FertilizerApp.html", 1, False`;

fs.writeFileSync('fertilizer-simple-app/RUN.vbs', vbsScript);

// Create instructions
const instructions = `# نظام إدارة مصنع الأسمدة
...
fs.writeFileSync('fertilizer-simple-app/README.txt', instructions);

// Create ZIP package
console.log('Creating ultra-simple application package...');
execSync('cd fertilizer-simple-app && zip -r "../FertilizerApp-Simple.zip" .');

console.log('');
console.log('✅ Ultra-Simple Windows Application Created!');
console.log('');
console.log('📦 Package: FertilizerApp-Simple.zip');
console.log('📁 Folder: fertilizer-simple-app/');
console.log('');
console.log('🔧 Super Simple Launch Options:');
console.log('1. RUN.bat - Simple batch file');
console.log('2. RUN.vbs - Silent VB script');
console.log('3. FertilizerApp.html - Direct HTML file');
console.log('');
console.log('💡 This version eliminates all command line complexity!');