...
console.log('Creating Improved Desktop Application...');
...
// Complete improved HTML application
...
<head>
    ...
    <style>
        ...
        * { 
        ...
        .ltr .language-switcher { left: 1rem; right: auto; }
...
<body class="bg-gray-50/80">
        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 px-3 py-4 space-y-2 overflow-y-auto">
                <button class="nav-item active" onclick="showPage('home')">
                    ...
                    <span class="nav-text font-medium text-sm" data-key="home">الرئيسية</span>
                </button>
                <button class="nav-item" onclick="showPage('dashboard')">
                    <i class="fas fa-chart-line"></i>
                    <span class="nav-text font-medium text-sm" data-key="dashboard">لوحة التحكم</span>
                </button>
                <button class="nav-item" onclick="showPage('sales')">
                    <i class="fas fa-shopping-cart"></i>
                    <span class="nav-text font-medium text-sm" data-key="sales">المبيعات</span>
                </button>
                <button class="nav-item" onclick="showPage('expenses')">
                    <i class="fas fa-money-bill"></i>
                    <span class="nav-text font-medium text-sm" data-key="expenses">المصروفات</span>
                </button>
                <button class="nav-item" onclick="showPage('workers')">
                    <i class="fas fa-users"></i>
                    <span class="nav-text font-medium text-sm" data-key="workers">العمال</span>
                </button>
                <button class="nav-item" onclick="showPage('storage')">
                    <i class="fas fa-warehouse"></i>
                    <span class="nav-text font-medium text-sm" data-key="storage">المخزون</span>
                </button>
                <button class="nav-item" onclick="showPage('activity-logs')">
                    <i class="fas fa-clipboard-list"></i>
                    <span class="nav-text font-medium text-sm" data-key="activityLogs">سجل الأنشطة</span>
                </button>
                <button class="nav-item" onclick="showPage('reports')">
                    <i class="fas fa-chart-pie"></i>
                    <span class="nav-text font-medium text-sm" data-key="reports">التقارير</span>
                </button>
                <button class="nav-item" onclick="showPage('settings')">
                    <i class="fas fa-cog"></i>
                    <span class="nav-text font-medium text-sm" data-key="settings">الإعدادات</span>
                </button>
            </nav>
    ...
    <div id="main-content" class="content-with-sidebar transition-all duration-300">
        ...
        <header class="bg-card border-b border-border px-6 py-4">
            <div class="flex items-center justify-between">
                <h1 id="page-title" class="text-2xl font-bold" data-key="home">الرئيسية</h1>
        ...
        <main class="container mx-auto px-6 py-6 max-w-7xl">
            ...
            <!-- Home Page -->
            <div id="home-page" class="page-content space-y-6">
                <!-- Hero Section -->
                <div class="hero-section">
                    <h1 class="text-4xl font-bold mb-4" data-key="welcomeTitle">مرحباً بك في نظام إدارة مصنع الأسمدة</h1>
                    <p class="text-xl opacity-90 mb-6" data-key="welcomeSubtitle">شركة الواصلون للتعدين والصناعات الكيميائية</p>
                    <p class="text-lg opacity-80" data-key="welcomeDescription">نظام شامل لإدارة جميع جوانب مصنع الأسمدة بكفاءة وسهولة</p>
                </div>

                <!-- Quick Stats Overview -->
                <div class="stats-overview">
                    <div class="stat-card">
                        <span class="stat-number" id="home-total-revenue">169,100</span>
                        <span class="stat-label" data-key="totalRevenue">إجمالي الإيرادات (ج.م)</span>
                    </div>
                    <div class="stat-card">
                        <span class="stat-number" id="home-total-products">4</span>
                        <span class="stat-label" data-key="totalProducts">إجمالي المنتجات</span>
                    </div>
                    <div class="stat-card">
                        <span class="stat-number" id="home-total-workers">4</span>
                        <span class="stat-label" data-key="totalWorkers">إجمالي العمال</span>
                    </div>
                    <div class="stat-card">
                        <span class="stat-number" id="home-profit">49,100</span>
                        <span class="stat-label" data-key="profit">صافي الربح (ج.م)</span>
                    </div>
                </div>
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div class="feature-card" onclick="showPage('dashboard')">
                        ...
                        <h3 class="text-lg font-semibold mb-2" data-key="dashboard">لوحة التحكم</h3>
                        <p class="text-muted-foreground" data-key="dashboardDesc">مراقبة الأداء المالي والإحصائيات المتقدمة</p>
                    </div>

                    <div class="feature-card" onclick="showPage('sales')">
                        <div class="feature-icon">
                            <i class="fas fa-shopping-cart"></i>
                        </div>
                        <h3 class="text-lg font-semibold mb-2" data-key="sales">إدارة المبيعات</h3>
                        <p class="text-muted-foreground" data-key="salesDesc">تتبع المبيعات وإدارة العملاء</p>
                    </div>

                    <div class="feature-card" onclick="showPage('expenses')">
                        <div class="feature-icon">
                            <i class="fas fa-money-bill"></i>
                        </div>
                        <h3 class="text-lg font-semibold mb-2" data-key="expenses">إدارة المصروفات</h3>
                        <p class="text-muted-foreground" data-key="expensesDesc">تتبع وتصنيف جميع المصروفات</p>
                    </div>

                    <div class="feature-card" onclick="showPage('workers')">
                        <div class="feature-icon">
                            <i class="fas fa-users"></i>
                        </div>
                        <h3 class="text-lg font-semibold mb-2" data-key="workers">إدارة العمال</h3>
                        <p class="text-muted-foreground" data-key="workersDesc">إدارة بيانات العمال والرواتب</p>
                    </div>

                    <div class="feature-card" onclick="showPage('storage')">
                        <div class="feature-icon">
                            <i class="fas fa-warehouse"></i>
                        </div>
                        <h3 class="text-lg font-semibold mb-2" data-key="storage">إدارة المخزون</h3>
                        <p class="text-muted-foreground" data-key="storageDesc">تتبع المواد الخام والمنتجات</p>
                    </div>
                    ...
                    <div class="feature-card" onclick="showPage('reports')">
                        ...
                        <h3 class="text-lg font-semibold mb-2" data-key="reports">التقارير</h3>
                        <p class="text-muted-foreground" data-key="reportsDesc">إنشاء تقارير مفصلة وتحليلات</p>
                    </div>
                </div>

                <!-- Quick Actions -->
                <div class="bg-card rounded-lg border border-border p-6">
                    <h3 class="text-lg font-semibold mb-4" data-key="quickActions">إجراءات سريعة</h3>
                    <div class="flex flex-wrap gap-3">
                        <button onclick="showPage('sales')" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
                            <span data-key="addSale">إضافة بيع جديد</span>
                        </button>
                        <button onclick="showPage('expenses')" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
                            <span data-key="addExpense">إضافة مصروف</span>
                        </button>
                        <button onclick="showPage('workers')" class="btn btn-primary">
                            <i class="fas fa-user-plus"></i>
                            <span data-key="addWorker">إضافة عامل</span>
                        </button>
                        <button onclick="showPage('storage')" class="btn btn-primary">
                            <i class="fas fa-box"></i>
                            <span data-key="addItem">إضافة مادة للمخزون</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- Dashboard Page -->
            <div id="dashboard-page" class="page-content space-y-6 hidden">
                <!-- Date Filter Tabs -->
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                        ...
                        <div class="text-2xl font-bold" id="total-revenue">169,100 ج.م</div>
                    ...
                    <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                        ...
                        <div class="text-2xl font-bold" id="total-expenses">120,000 ج.م</div>
                        <p class="text-xs text-muted-foreground">
                    ...
                    <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                        ...
                        <div class="text-2xl font-bold text-green-600" id="profit">49,100 ج.م</div>
            ...
            <div id="sales-page" class="page-content space-y-6 hidden">
                ...
                <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            <label data-key="totalAmount">المبلغ الإجمالي (ج.م)</label>
            ...
            <div id="workers-page" class="page-content space-y-6 hidden">
                ...
                <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            <label data-key="monthlySalary">الراتب الشهري (ج.م)</label>
            ...
            <div id="storage-page" class="page-content space-y-6 hidden">
                ...
                <div class="bg-card rounded-lg border border-border p-6 shadow-sm">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            <label data-key="purchasePricePerTon">سعر الوحدة (ج.م)</label>
    ...
    <script>
        ...
        const translations = {
            ar: {
                ...
                purchasePricePerTon: "سعر الوحدة (ج.م)",
                dealerName: "المورد",
                addItem: "إضافة مادة جديدة",
                totalCost: "القيمة الإجمالية",
                welcomeTitle: "مرحباً بك في نظام إدارة مصنع الأسمدة",
                welcomeSubtitle: "شركة الواصلون للتعدين والصناعات الكيميائية",
                welcomeDescription: "نظام شامل لإدارة جميع جوانب مصنع الأسمدة بكفاءة وسهولة",
                dashboardDesc: "مراقبة الأداء المالي والإحصائيات المتقدمة",
                salesDesc: "تتبع المبيعات وإدارة العملاء",
                expensesDesc: "تتبع وتصنيف جميع المصروفات",
                workersDesc: "إدارة بيانات العمال والرواتب",
                storageDesc: "تتبع المواد الخام والمنتجات",
                reportsDesc: "إنشاء تقارير مفصلة وتحليلات",
                quickActions: "إجراءات سريعة",
                addSale: "إضافة بيع جديد"
            },
            en: {
                home: "Home",
                dashboard: "Dashboard",
                ...
                purchasePricePerTon: "Unit Price (EGP)",
                dealerName: "Supplier",
                addItem: "Add New Item",
                totalCost: "Total Value",
                welcomeTitle: "Welcome to Fertilizer Factory Management System",
                welcomeSubtitle: "Al-Wasiloon Mining and Chemical Industries Company",
                welcomeDescription: "Comprehensive system for managing all aspects of fertilizer factory efficiently",
                dashboardDesc: "Monitor financial performance and advanced analytics",
                salesDesc: "Track sales and manage customers",
                expensesDesc: "Track and categorize all expenses",
                workersDesc: "Manage worker data and salaries",
                storageDesc: "Track raw materials and products",
                reportsDesc: "Generate detailed reports and analytics",
        ...
        function updateHomeStats() {
            ...
            document.getElementById('home-total-revenue').textContent = totalIncome.toLocaleString();
            document.getElementById('home-total-products').textContent = appData.storage.length;
            document.getElementById('home-total-workers').textContent = appData.workers.length;
            document.getElementById('home-profit').textContent = profit.toLocaleString();
        }
...
fs.writeFileSync('desktop-app/FertilizerApp.html', improvedHTML);
...
const readmeContent = `# نظام إدارة مصنع الأسمدة - النسخة المحسنة
...
console.log('Creating improved desktop application package...');
execSync('cd desktop-app && zip -r "../Fertilizer-Factory-Management-Enhanced.zip" .');

console.log('');
console.log('✅ Enhanced Desktop Application Created Successfully!');
console.log('');
console.log('📦 Package: Fertilizer-Factory-Management-Enhanced.zip');
console.log('📁 Folder: desktop-app/');
console.log('');
console.log('🔧 Enhancements Made:');
console.log('✓ Homepage with welcome interface and quick stats');
console.log('✓ Language switcher repositioned to top-right corner');
console.log('✓ FontAwesome icons displaying properly');
console.log('✓ Egyptian Pound (ج.م/EGP) currency implementation');
console.log('✓ Interactive feature cards on homepage');
console.log('✓ Quick action buttons for common tasks');
console.log('✓ Better icon spacing and visibility');
...
console.log('- Welcome homepage with company branding');
console.log('- Compact language toggle (عر/EN) in top-right');
console.log('- All amounts displayed in Egyptian Pounds');
console.log('- Clear FontAwesome icons throughout');
console.log('- Interactive dashboard and feature cards');