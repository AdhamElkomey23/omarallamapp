...
export const translations = {
  en: {
    ...
    deleteItemConfirmation: "Delete Confirmation",
    yes: "Yes",
    no: "No",
    ...
    manageStorageItems: "Manage storage items and inventory",
  ...
  ar: {
    ...
    totalDaysWorked: "إجمالي أيام العمل",
    totalAbsent: "إجمالي أيام الغياب",
    totalLate: "إجمالي أيام التأخير",
    ...
    attendanceDeleted: "تم حذف الحضور بنجاح",
    ...
    deleteItemConfirmation: "تأكيد الحذف",
    yes: "نعم",
    no: "لا",
    ...
    dealerContact: "جهة اتصال التاجر",
    ...
    manageStorageItems: "إدارة عناصر التخزين والمخزون",
