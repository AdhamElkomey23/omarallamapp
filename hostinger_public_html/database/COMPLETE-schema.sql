...
CREATE INDEX IF NOT EXISTS idx_salary_deductions_month ON salary_deductions(deduction_month);
CREATE INDEX IF NOT EXISTS idx_salary_deductions_worker ON salary_deductions(worker_id);
