...
console.log('Creating Windows Desktop Application (Fixed Version)...');

// Create app directory
if (fs.existsSync('fertilizer-app-windows')) {
  execSync('rm -rf fertilizer-app-windows');
}
fs.mkdirSync('fertilizer-app-windows', { recursive: true });

// Create the complete HTML application (same content as before)
const desktopHTML = `<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>نظام إدارة مصنع الأسمدة</title>
    <style>
...
// Write the HTML file with English name
fs.writeFileSync('fertilizer-app-windows/Fertilizer-Factory-Management.html', desktopHTML);

// Create Windows batch file with English name and proper encoding
const windowsBatch = `@echo off
chcp 65001 >nul
title Fertilizer Factory Management System
cls
echo ================================================
...
echo.
start "" "Fertilizer-Factory-Management.html"
echo.
...
fs.writeFileSync('fertilizer-app-windows/Start-Application.bat', windowsBatch);

// Create PowerShell script with English name
...
$htmlFile = Join-Path $PSScriptRoot "Fertilizer-Factory-Management.html"
...
fs.writeFileSync('fertilizer-app-windows/Start-Application.ps1', powershellScript);

// Create README file
const readmeContent = `# Fertilizer Factory Management System
...
fs.writeFileSync('fertilizer-app-windows/README.md', readmeContent);

// Create ZIP package
console.log('Creating fixed desktop application package...');
execSync('cd fertilizer-app-windows && zip -r "../Fertilizer-Factory-Management-Windows.zip" .');

console.log('');
console.log('✅ Fixed Windows Desktop Application Created Successfully!');
console.log('');
console.log('📦 Package: Fertilizer-Factory-Management-Windows.zip');
console.log('📁 Folder: fertilizer-app-windows/');
console.log('');
console.log('🔧 Fixed Issues:');
console.log('- Used English filenames to avoid encoding issues');
console.log('- Added proper UTF-8 encoding support');
console.log('- Simplified batch file execution');
console.log('- Added multiple launch methods');
console.log('');
console.log('🚀 How to use:');
console.log('1. Extract the ZIP file to any folder');
console.log('2. Double-click "Start-Application.bat"');
console.log('3. Application opens in your default browser');
console.log('4. All data saves automatically');
console.log('');
console.log('💡 This version should work without any encoding errors!');